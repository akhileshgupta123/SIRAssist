...
const SAMPLE_SCENARIOS: SampleScenario[] = [
  ...
  {
    id: 'scen-20',
    title: 'Cross-Constituency Shifted Elector Duplicate Pair',
    subtitle: 'Sudip Kumar Roy (AC-164) vs Sudip Roy (AC-160 Salt Lake)',
    category: 'Deceased/Shifted Flag',
    severity: 'Critical',
    constituency: 'AC-160 Bidhannagar, Part 04',
    reportedBy: 'Inter-Constituency Migration Engine',
    voterName: 'Sudip Roy',
    epicNumber: 'EPIC-WB-2026-77402',
    description: 'Shifted elector registered new Form 6 in AC-160 Salt Lake without Form 7 deletion in source AC-164 constituency. 96.2% demographic vector match.',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-77401',
    badgeTag: 'Shifted Voter Test',
  },
  {
    id: 'scen-21',
    title: 'Deceased Elector Residual Ghost Duplicate Entry',
    subtitle: 'Manorama Devi (AC-164) vs Manorama Devi Prasad (AC-165)',
    category: 'Deceased/Shifted Flag',
    severity: 'Critical',
    constituency: 'AC-165 Jadavpur, Part 14',
    reportedBy: 'Municipal Death Registry & Anti-Ghost Agent',
    voterName: 'Manorama Devi Prasad',
    epicNumber: 'EPIC-WB-2026-77502',
    description: 'Municipal death certificate registered in AC-164 for 78yr elector. Active residual duplicate entry detected in AC-165 Jadavpur (97% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-77501',
    badgeTag: 'Deceased Ghost Test',
  },
  {
    id: 'scen-22',
    title: 'Permanently Migrated Elector Transliterated Duplicate Pair',
    subtitle: 'Amalendu Bhattacharya (AC-164) vs Amalendu Bhattacharjee (AC-159)',
    category: 'Deceased/Shifted Flag',
    severity: 'High',
    constituency: 'AC-159 Bhabanipur, Part 08',
    reportedBy: 'SIR Door-to-Door Audit Agent',
    voterName: 'Amalendu Bhattacharjee',
    epicNumber: 'EPIC-WB-2026-77602',
    description: 'Door-to-door SIR audit flagged elector permanently shifted to AC-159 Bhabanipur under transliterated surname spelling. Source entry remains active.',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-77601',
    badgeTag: 'Migrated Voter Test',
  },
  {
    id: 'scen-23',
    title: 'Cross-Constituency Parent Age Gap Disparity Pair',
    subtitle: 'Rahul Kailash Sharma (AC-164) vs Rahul Sharma (AC-165 Jadavpur)',
    category: 'Age/Relative Mismatch',
    severity: 'Critical',
    constituency: 'AC-165 Jadavpur, Part 04',
    reportedBy: 'Biological Age Audit Engine',
    voterName: 'Rahul Sharma',
    epicNumber: 'EPIC-WB-2026-66102',
    description: '4-year parent-child age gap recorded on primary Form 6 in AC-164 (Father 32 vs Son 28). Secondary registration in AC-165 records father age as 58 (94% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-66101',
    badgeTag: 'Father Age Gap Test',
  },
  {
    id: 'scen-24',
    title: 'Intra-AC Father vs Husband Relation Mismatch Pair',
    subtitle: 'Pooja Mukherjee (Part 09) vs Pooja Mukherjee Chatterjee (Part 14)',
    category: 'Age/Relative Mismatch',
    severity: 'High',
    constituency: 'AC-164 Kolkata South, Part 14',
    reportedBy: 'Marital Relation Integrity Agent',
    voterName: 'Pooja Mukherjee Chatterjee',
    epicNumber: 'EPIC-WB-2026-66202',
    description: 'Duplicate enrollment across Part 09 and Part 14 with conflicting relative type tag (Father vs Husband for same relative Subrata Mukherjee, 95% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-66201',
    badgeTag: 'Relation Type Test',
  },
  {
    id: 'scen-25',
    title: 'Biological Age Gap Inversion Cross-AC Pair',
    subtitle: 'Bikash Chakraborty (AC-164) vs Bikash Ranjan Chakraborty (AC-165)',
    category: 'Age/Relative Mismatch',
    severity: 'Critical',
    constituency: 'AC-165 Jadavpur, Part 12',
    reportedBy: 'Generational Audit Agent',
    voterName: 'Bikash Ranjan Chakraborty',
    epicNumber: 'EPIC-WB-2026-66302',
    description: 'Father-son biological age gap inverted on primary card (Elector 54 vs Father 24). Cross-AC duplicate in Jadavpur records correct father age of 82 (96% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-66301',
    badgeTag: 'Age Inversion Test',
  },
  {
    id: 'scen-26',
    title: 'Cross-AC Multi-Name Structural Variance Demographic Pair',
    subtitle: 'Subhas Chandra Bose Ray (AC-164) vs Subhash Ray (AC-165)',
    category: 'Demographic Inconsistency',
    severity: 'Critical',
    constituency: 'AC-165 Jadavpur, Part 08',
    reportedBy: 'Demographic Name Variance Agent',
    voterName: 'Subhash Ray',
    epicNumber: 'EPIC-WB-2026-55202',
    description: 'Cross-constituency duplicate enrollment with middle-name omission (Subhas Chandra Bose Ray vs Subhash Ray). Demographic match score 95% across age, gender, and father name.',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-55201',
    badgeTag: 'Name Structure Test',
  },
  {
    id: 'scen-27',
    title: 'Intra-AC Gender-Relation Tag Contradiction Pair',
    subtitle: 'Sanjay Sen (Part 08) vs Sanjay Kumar Sen (Part 12)',
    category: 'Demographic Inconsistency',
    severity: 'High',
    constituency: 'AC-164 Kolkata South, Part 12',
    reportedBy: 'Demographic Tag Consistency Agent',
    voterName: 'Sanjay Kumar Sen',
    epicNumber: 'EPIC-WB-2026-55302',
    description: 'Intra-constituency duplicate enrollment across Part 08 and Part 12 with conflicting relation tag (Father in Part 08 vs Husband for Male voter in Part 12, 94% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-55301',
    badgeTag: 'Gender Tag Test',
  },
  {
    id: 'scen-28',
    title: 'Single-Character Incomplete Initial Demographic Pair',
    subtitle: 'Monojit Bandyopadhyay (Part 02 Booth 03-A) vs M (Booth 03-B)',
    category: 'Demographic Inconsistency',
    severity: 'High',
    constituency: 'AC-164 Kolkata South, Part 02',
    reportedBy: 'Name Truncation Audit Engine',
    voterName: 'M',
    epicNumber: 'EPIC-WB-2026-55402',
    description: 'Single-character incomplete registration (M / B) submitted in online draft roll matches full legal record Monojit Bandyopadhyay (Father Bireswar Bandyopadhyay, 93% match).',
    expectedDuplicate: true,
    duplicateMatchTarget: 'EPIC-WB-2026-55401',
    badgeTag: 'Initial Truncation Test',
  },
];
